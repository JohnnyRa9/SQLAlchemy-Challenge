...
@app.route("/")
def welcome():
    return (f"<h1>Welcome to the Hawaii App API!</h1>"
            f"This is a Flask API for Climate Analysis .<br/><br/>"
            f" <img width='200' src='http://3.bp.blogspot.com/_pYhtd5F751g/R0I3lFiGTeI/AAAAAAAAAlU/Drr9fBJ27mE/s1600/Chicken+Joe.jpg'<br/>"
